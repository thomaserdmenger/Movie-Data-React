    ...
    <>
      <main>
        <section className='flex flex-col pt-36 items-center bg-[#232327] pb-28'>
          <h1 className='text-5xl font-extralight mb-14 text-white'>
          ...
          <form
            ...
            <input
              className='border-2 border-purple-600 bg-[#232327] rounded-full px-2 py-2 text-center text-gray-300 placeholder:text-gray-300 w-4/12 outline-none shadow-lg shadow-purple-900'
              type='text'
              name='userInput'
              id='userInput'
              value={userInput}
